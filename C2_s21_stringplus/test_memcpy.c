...
START_TEST(basic) {
  ...
  char str2[] = "12";
  // Act
  void *check = memcpy(str1, str2, 2);
  void *s21_check = s21_memcpy(str1, str2, 2);
  // Assert
...
START_TEST(overlap_copy) {
  ...
  // Act
  void *check = memcpy(str1 + 6, str1, 5);
  void *s21_check = s21_memcpy(str1 + 6, str1, 5);
  // Assert
  ck_assert_ptr_eq(check, s21_check);
}
END_TEST
...
START_TEST(small_range_n) {
  ...
  char str2[] = "111";
  // Act
  void *check = memcpy(str1, str2, 1);
  void *s21_check = s21_memcpy(str1, str2, 1);
  // Assert
  ck_assert_ptr_eq(check, s21_check);
}
END_TEST
...
START_TEST(zero_n) {
  ...
  char str2[] = "111";
  // Act
  void *check = memcpy(str1, str2, 0);
  void *s21_check = s21_memcpy(str1, str2, 0);
  // Assert
  ck_assert_ptr_eq(check, s21_check);
}
END_TEST
