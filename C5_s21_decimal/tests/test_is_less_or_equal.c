...
Suite *is_less_or_equal_test_suite() {
  Suite *s = suite_create("is_less_or_equal_test_suite");
  TCase *tc = tcase_create("is_less_or_equal_test_suite");
...
int test_is_less_or_equal() {
  ...
  Suite *s = is_less_or_equal_test_suite();
